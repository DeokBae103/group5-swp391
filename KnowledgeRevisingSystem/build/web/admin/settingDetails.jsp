                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input  name="order" type="number" class="form-control" value="${order}" oninput="enforceMaxLength(event)">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <c:if test="${requestScope.warn == 0}">
                                                            ...
                                                            <span class="text-danger pl-1">
                                                                Update not successful because Setting type ${type} name ${name} already existed</span> 
                                                        </c:if>
