                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input name="subject_name" id="name" type="text" class="form-control" value="${subject_name}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input name="subject_code" type="text" class="form-control" value="${subject_code}">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <c:if test="${requestScope.warn ==0}">
                                                            ...
                                                            <span class="text-danger pl-1">
                                                                Update subject not successful because Subject name "${subject_name}" code "${subject_code}" already existed</span> 
                                                            </c:if>
                                                            <c:if test="${requestScope.warn == 1}">
                                                            <img class="ml-3"src="/krs/assets/images/check.png" width="15px">
                                                            <span class="text-success pl-1">
                                                                Update subject successful</span> 
                                                            </c:if>  
                                                    </div><!--end col-->
