                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" placeholder="Enter Your Email Address" name="email" value="${requestScope.emailvalue}" required="">
                                            </div>
                                        ...
                                        <div class="mx-auto">
                                            <p class="mb-0 mt-3"><small class="text-dark me-2">Remember your password ?</small> <a href="UserServlet?action=login" class="text-dark h6 mb-0">Sign in</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
